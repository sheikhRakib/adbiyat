...
@section('content')
    <div class="card">
        ...
        {!! Form::open(['route'=>'backend.admin.article.store', 'method'=>'post','id'=>'dataForm']) !!}
        <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6 form-group">
                  ...
                  {!! Form::select('author_id',$authors,'',['class'=>$errors->has('author_id')?'form-control is-invalid':'form-control required']) !!}
              </div>
              <div class="col-md-6 form-group">
                ...
                <div class="col-md-12 form-group">
                    ...
                    {!! Form::textarea('body','',['class'=>$errors->has('body')?'form-control is-invalid':'form-control required','rows'=>'5','placeholder'=>'Write article content...','id'=>'body']) !!}
                </div>
